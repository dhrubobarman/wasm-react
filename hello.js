...
["_memory","_pingIt","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
;
 ...
 function $14($0_1) {
  ...
  label$1 : {
   ...
   $1_1 = 0;
   label$2 : {
    if (!(HEAP32[(0 + 65544 | 0) >> 2] | 0)) {
     break label$2
    }
    $1_1 = $14(HEAP32[(0 + 65544 | 0) >> 2] | 0 | 0) | 0;
   }
   label$3 : {
    if (!(HEAP32[(0 + 65544 | 0) >> 2] | 0)) {
     break label$3
    }
    $1_1 = $14(HEAP32[(0 + 65544 | 0) >> 2] | 0 | 0) | 0 | $1_1 | 0;
   }
   label$4 : {
    $0_1 = HEAP32[($10() | 0) >> 2] | 0;
    if (!$0_1) {
...
var _pingIt = Module['_pingIt'] = createExportWrapper('pingIt', 0);
